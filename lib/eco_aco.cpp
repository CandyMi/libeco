...
aco_share_stack_t* aco_share_stack_new2(size_t sz, char guard_page_enabled){
    ...
    aco_share_stack_t* p = (aco_share_stack_t*)eco_malloc(sizeof(aco_share_stack_t));
    assertalloc_ptr(p);
...
aco_t* aco_create(
    ...
    aco_t* p = (aco_t*)eco_malloc(sizeof(aco_t));
    assertalloc_ptr(p);
    ...
    if(main_co != nullptr){ // non-main co
        ...
        p->save_stack.ptr = eco_malloc(save_stack_sz);
